...
const TRAINER_NAV: NavItem[] = [
  ...
  { href: "/trainer/training-tracker", label: "Batches", icon: Layers },
  { href: "/trainer/programs", label: "Courses", icon: BookOpen },
  { href: "/trainer/trainees", label: "Course trainees", icon: Users },
